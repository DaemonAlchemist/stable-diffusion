...
return <Row className={styles.params} gutter={16}>
    <Col xs={12}>
        <div>Width <b>{width} px</b><Slider disabled={sizeSource !== "manual"} min={0} max={1024} step={64} value={width} onChange={setWidth} marks={{0: " ", 1024: " "}}/></div>
        <div>Height <b>{height} px</b><Slider disabled={sizeSource !== "manual"} min={0} max={1024} step={64} value={height} onChange={setHeight} marks={{0: " ", 1024: " "}}/></div>
    </Col>
    <Col xs={12}>
